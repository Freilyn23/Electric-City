...
<!--
Conexiones a las clases de Bootstrap, GoogleAPIS para las fuentes, y al documento de estilos CSS.
-->
...
<!--
Div de imagen principal de la pagina.
-->
...
<!--
Div de la ultimas publicaciones con u carrusel de fotos.
-->
        ...
        <br><br>
          ...
          <div class="swiper mySwiper">
              <div class="swiper-wrapper">
                <div class="swiper-slide" style="background-image:url(views/img/samsung.png);background-size:contain;background-repeat:no-repeat"></div>
                <div class="swiper-slide" style="background-image:url(views/img/samsung.png);background-size:contain;background-repeat:no-repeat"></div>
                <div class="swiper-slide" style="background-image:url(views/img/samsung.png);background-size:contain;background-repeat:no-repeat"></div>
                <div class="swiper-slide" style="background-image:url(views/img/samsung.png);background-size:contain;background-repeat:no-repeat"></div>
                <div class="swiper-slide" style="background-image:url(views/img/samsung.png);background-size:contain;background-repeat:no-repeat"></div>
        ...
        <div class="col-md-6">
          <div class="row">
            <div class="col-12 d-flex justify-content-center p-3">
              <button class="btn btn-light btn-lg center-block rounded">Contactanos</button>
            </div>
          </div>
        </div>
        <br><br>
